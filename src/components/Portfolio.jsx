          ...
          >
            {categories.map((cat) => (
              <button
                ...
                className={`relative px-4 py-2 rounded-xl text-sm font-bold z-10 transition-colors duration-200 ${
                  filter === cat ? "text-white" : "text-slate-500 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white"
                }`}
              >
                {filter === cat && (
                  <motion.div
      ...
      <div className="max-w-4xl mx-auto mt-32 px-4">
        <div className="bg-slate-900 dark:bg-indigo-950 rounded-[2.5rem] p-12 md:p-16 text-center relative overflow-hidden group">
             ...
             <div className="relative z-10">
                ...
                <Link to="/contact" className="inline-flex items-center gap-2 bg-white text-indigo-900 font-bold px-10 py-4 rounded-full hover:bg-indigo-50 hover:scale-105 transition-all shadow-xl">
