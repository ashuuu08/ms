    ...
    <div className="w-full overflow-x-hidden bg-white dark:bg-slate-950 min-h-screen pt-28 pb-20 transition-colors duration-300 font-sans">
      <div className="max-w-7xl mx-auto px-4">
        ...
        >
          ...
          {/* 1. DEVELOPMENT (MERN/JAVA) - Wide */}
          <Link to="/services/development" className="contents">
            <motion.div
              variants={itemVariants}
              whileHover={{ y: -5 }}
              whileTap={{ scale: 0.98 }}
              className="md:col-span-2 bg-gradient-to-br from-blue-50 to-white dark:from-slate-900 dark:to-slate-800 cursor-pointer rounded-3xl p-8 shadow-sm border border-blue-100 dark:border-slate-700 relative overflow-hidden group flex flex-col justify-between"
            >
              ...
              <div className="relative z-10 flex flex-col md:flex-row justify-between gap-6 items-start mb-6">
                <div>
                  <div className="flex items-center gap-2 mb-3">
                    ...
                    <span className="text-xs font-bold text-blue-500 uppercase tracking-wider">Core Tech</span>
                  </div>

                  <div className="flex items-center gap-3 mb-4">
                    <div className="bg-blue-100 dark:bg-blue-900/30 p-2 rounded-lg text-blue-600"><Globe size={24} /></div>
                    <h2 className="text-2xl font-bold text-slate-900 dark:text-white">Full-Stack Dev</h2>
                  </div>
                  <p className="text-slate-600 dark:text-slate-400 max-w-md">
                    MERN Stack & Java Solutions. We build scalable web applications with clean code and microservices architecture.
                  </p>
                </div>
                <div className="flex gap-2">
                  <Coffee size={40} className="text-orange-500 opacity-20" />
                  <Code2 size={40} className="text-blue-500 opacity-20" />
                </div>
              </div>

              <div className="relative z-10 flex items-center text-blue-600 font-bold group-hover:gap-2 transition-all">
                View Development stack <ArrowRight size={18} className="ml-1" />
              </div>
            </motion.div>
          </Link>

          {/* 2. AUTOMATION (Tall Card) */}
          <Link to="/services/automation" className="contents">
            <motion.div
              variants={itemVariants}
              whileHover={{ y: -5 }}
              whileTap={{ scale: 0.98 }}
              className="md:row-span-2 bg-white dark:bg-slate-900 cursor-pointer rounded-3xl border-l-4 border-green-500 p-8 shadow-sm hover:shadow-xl transition-all relative overflow-hidden group flex flex-col justify-between"
            >
              ...
              <div className="relative z-10">
                ...
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <span className="text-xs font-bold text-green-600 dark:text-green-400 uppercase tracking-wider">Efficiency</span>
                </div>

                <h2 className="text-3xl font-bold text-slate-900 dark:text-white mb-4">Automation</h2>
                <p className="text-slate-600 dark:text-slate-400 mb-6 leading-relaxed">
                  Eliminate manual data entry. We script Google Sheets, Gmail, and Forms to work for you.
                </p>
                <div className="space-y-3 mb-8">
                  ...
                  <div className="flex items-center gap-2 text-sm text-slate-700 dark:text-slate-300">
                    <span className="w-1.5 h-1.5 rounded-full bg-green-500"></span> Auto Invoicing
                  </div>
                  <div className="flex items-center gap-2 text-sm text-slate-700 dark:text-slate-300">
          ...
          {/* 3. CLOUD & SUPABASE */}
          <Link to="/services/cloud" className="contents">
            <motion.div
              variants={itemVariants}
              whileHover={{ y: -5 }}
              whileTap={{ scale: 0.98 }}
              className="bg-white dark:bg-slate-900 cursor-pointer rounded-3xl border border-slate-200 dark:border-slate-800 p-8 shadow-sm relative overflow-hidden group transition-transform flex flex-col justify-between h-full"
            >
              ...
              <div>
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <span className="text-xs font-bold text-emerald-500 uppercase tracking-wider">Database</span>
                </div>

                <div className="flex justify-between items-center mb-4">
                  <h2 className="text-xl font-bold text-slate-900 dark:text-white">Supabase Cloud</h2>
                </div>
                <p className="text-sm text-slate-600 dark:text-slate-400 mb-6">
                  Real-time databases and serverless edge functions for modern apps.
                </p>
              </div>

              <div className="flex items-center text-emerald-600 text-sm font-bold group-hover:gap-2 transition-all">
                View Cloud <ArrowRight size={16} className="ml-1" />
              </div>
            </motion.div>
          </Link>

          {/* 4. MARKETING */}
          <Link to="/services/marketing" className="contents">
            <motion.div
              variants={itemVariants}
              whileHover={{ y: -5 }}
              whileTap={{ scale: 0.98 }}
            ...
            >
              ...
              <div>
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <span className="text-xs font-bold text-orange-500 uppercase tracking-wider">Growth</span>
                </div>

                <div className="flex justify-between items-center mb-4">
                  <h2 className="text-xl font-bold text-slate-900 dark:text-white">Marketing</h2>
                </div>
                <p className="text-sm text-slate-600 dark:text-slate-400 mb-6">
                  High-ROI campaigns on Google & Social. We find your customers.
                </p>
              </div>

              <div className="flex items-center text-orange-600 text-sm font-bold group-hover:gap-2 transition-all">
                See Strategies <ArrowRight size={16} className="ml-1" />
              </div>
            </motion.div>
          </Link>
          ...
          <Link to="/services/ai" className="contents">
            <motion.div
              ...
              whileHover={{ y: -5 }}
              whileTap={{ scale: 0.98 }}
              className="md:col-span-2 bg-slate-900 cursor-pointer rounded-3xl p-8 shadow-xl relative overflow-hidden text-white group hover:shadow-purple-500/20 transition-shadow flex flex-col md:flex-row justify-between items-center gap-6"
            >
              ...
              <div className="relative z-10 flex-1">
                ...
                <p className="text-slate-300 text-sm max-w-sm">
                  Custom ChatGPT bots, predictive analytics, and Python AI models integrated directly into your business.
                </p>
              </div>

              <div className="relative z-10 flex items-center gap-4">
                <Bot size={48} className="text-purple-400 opacity-50" />
                <div className="flex items-center text-purple-300 text-sm font-bold group-hover:gap-2 transition-all bg-white/10 px-4 py-2 rounded-full">
          ...
          <Link to="/services/enterprise" className="contents">
            <motion.div
              ...
              whileHover={{ y: -5 }}
              whileTap={{ scale: 0.98 }}
              className="md:col-span-3 bg-slate-950 cursor-pointer rounded-3xl p-10 shadow-2xl relative overflow-hidden text-white group border border-slate-800 flex flex-col md:flex-row items-center justify-between gap-8"
            >
        ...
        <div className="py-24 mt-16 relative">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 relative">
            ...
            {[
              ...
              >
                <div className="w-12 h-12 mx-auto bg-indigo-600 text-white rounded-xl flex items-center justify-center mb-4 shadow-lg relative z-10">
                  <step.icon size={20} />
                </div>
        ...
        <div className="mt-20 text-center">
          <Link to="/contact">
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className="inline-flex items-center gap-3 px-8 py-4 bg-indigo-600 text-white font-bold text-lg rounded-full hover:bg-indigo-700 transition shadow-xl shadow-indigo-500/30"
            >
