...
const Enterprises = () => {
    ...
    return (
        <div className="min-h-screen w-full max-w-full pt-28 pb-20 px-4 sm:px-6 lg:px-8 bg-slate-50 dark:bg-slate-950 transition-colors duration-300 relative overflow-hidden font-sans">
            <SEO 
                title="Enterprise Tech Infrastructure - Security & Scale" 
                description="Scalable, mission-critical infrastructure for enterprises. AshbitSoft delivers secure, compliant, and high-performance technical solutions for large operations."
                ogUrl="/solutions/enterprises"
            />
            ...
            <div className="max-w-7xl mx-auto relative z-10">
                    ...
                    {features.map((feature, index) => {
                        ...
                        return (
                            <motion.div
                                key={index}
                                whileHover={{ y: -8 }}
                                className="group bg-white dark:bg-slate-900 rounded-3xl p-8 shadow-lg border-2 border-slate-200 dark:border-slate-800 hover:shadow-xl transition-all duration-300"
                            >
                ...
                >
                    ...
                    <div className="grid md:grid-cols-4 gap-8">
                        {[
                            { value: "99.99%", label: "Uptime SLA", icon: "⚡", gradient: "from-green-500 to-emerald-500" },
                            { value: "<20ms", label: "Response Time", icon: "🚀", gradient: "from-blue-500 to-cyan-500" },
                            { value: "10M+", label: "Requests/Day", icon: "📊", gradient: "from-purple-500 to-pink-500" },
                            { value: "24/7", label: "Expert Support", icon: "💬", gradient: "from-indigo-500 to-purple-500" }
                        ].map((stat, index) => (
                            <motion.div
                                key={index}
                ...
                <div className="text-center bg-gradient-to-br from-indigo-900 to-slate-900 rounded-3xl p-12 relative overflow-hidden text-white shadow-2xl">
                    ...
                    <div className="relative z-10">
                        ...
                        <p className="text-lg text-indigo-100 mb-8 max-w-2xl mx-auto">
                            Let's discuss your enterprise needs and create a custom solution that scales with your organization.
                        </p>
                        <Link to="/contact">
                            <motion.button
